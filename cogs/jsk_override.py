...
emote = EmojiSettings(
    start=FakeEmote.from_name("<a:loading:585958072850317322>"),
...
async def attempt_add_reaction(msg: discord.Message, reaction: Union[str, discord.Emoji]):
    ...
    """
    reacts = {
        "\N{WHITE HEAVY CHECK MARK}": "<:yesfish:810187479466115102>",
        "\N{BLACK RIGHT-POINTING TRIANGLE}": "<a:loading:585958072850317322>",
        "\N{HEAVY EXCLAMATION MARK SYMBOL}": "<:nofish:810190767746318376>",
        "\N{DOUBLE EXCLAMATION MARK}": "<:nofish:810190767746318376>",
